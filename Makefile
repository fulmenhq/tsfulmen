...
verify-dist-asset-partition: ## Guard: embedded corpus lives in shared chunks, not public entries (run after build)
	@bunx tsx scripts/verify-dist-asset-partition.ts
