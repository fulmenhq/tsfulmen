...
> **⚠️ PACKAGE DEPRECATED**: This version was published to npm but has a critical bug where signal catalog loading fails in installed packages. The package has been deprecated on npm. **Use v0.1.10 or later instead.**
>
> **Root Cause**: Path resolution bug in signals catalog loader due to tsup bundling behavior. Fixed in v0.1.10 with runtime path detection and comprehensive pre-publish verification.

**Release Date:** November 16, 2025
**Release Type:** New Modules + Security Enhancements
**Status:** ⚠️ Deprecated (use v0.1.10+)
